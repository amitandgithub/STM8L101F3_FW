...
void Spi_Master_Tests()
{
  ...
  while(1)
  {
    ...
    case w25qxx_POLL_TXN:      
      Transaction.TxBuf.Buf = pBuffer;
      Transaction.TxBuf.Len = 5;
      Transaction.RxBuf.Buf = 0;
    ...
    case w25qxx_INTR_TX:         
      ...
      Cs.High();
    case SLAVE_INTR_INIT:    
      Transaction.TxBuf.Buf = SPI_RxBuf;
      Transaction.TxBuf.Len = 5;
      Transaction.RxBuf.Buf = SPI_RxBuf;
      Transaction.RxBuf.Len = 5;
