...
#define I2C_BUF_BYTE_IN(__I2C_BUF)      __I2C_BUF->Buf[__I2C_BUF->Idx++] = I2C_DATA_REG; __I2C_BUF->Len--

#define I2C_BUF_BYTE_OUT(__I2C_BUF)      I2C_DATA_REG = __I2C_BUF->Buf[__I2C_BUF->Idx++]; __I2C_BUF->Len--
...
public:
  ...
  typedef void(*i2cMasterCallback_t)();
  
  typedef void(*i2cSlaveCallback_t)(I2CState_t state, i2cBuf_t* i2cBuf);
  ...
  void SetSlaveTxCallback(i2cSlaveCallback_t I2CSlaveCallback){m_SlaveContext.SlaveTxCallback = I2CSlaveCallback;}
  
  void SetSlaveRxCallback(i2cSlaveCallback_t I2CSlaveCallback){m_SlaveContext.SlaveRxCallback = I2CSlaveCallback;}
  
  void SwapBuf(i2cBufType_t BufType, i2cBuf_t* i2cBuf);
...
private:
  ...
  i2cMasterContext_t            m_MasterContext;
  
  i2cSlaveContext_t             m_SlaveContext;
