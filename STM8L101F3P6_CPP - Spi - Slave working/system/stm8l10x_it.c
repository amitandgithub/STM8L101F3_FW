...
//        SPI->DR = *HAL::Spi::m_Transaction.TxBuf++; 
//        HAL::Spi::m_Transaction.TxLen--;
      ...
      {             
        ...
        //SPI_WAIT_FOR_TXE_FLAG_TO_SET(SPI,20000);
...
//      *HAL::Spi::m_Transaction.RxBuf = SPI->DR;
//      HAL::Spi::m_Transaction.RxBuf++;
//      HAL::Spi::m_Transaction.RxLen--;
