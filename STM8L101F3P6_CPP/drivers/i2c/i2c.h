...
public:
  ...
  typedef void(*i2cMasterCallback_t)(i2cBuf_t* i2cBuf);
  
  typedef void(*i2cSlaveCallback_t)(i2cBuf_t* i2cBuf);
  ...
  void ByteIn(){*m_Transaction.RxBuf++ = I2C->DR; m_Transaction.RxLen--; }
  
  void ByteOut(){I2C->DR = *m_Transaction.TxBuf++;  m_Transaction.TxLen--; }
