...
protected:
  ...
  //using timer = gpt<Timerx,tick,Autoreload,1>;
public:
  ...
  uint8_t HwInit(void)
  {
    ...
    gpt<Timerx,tick,Autoreload,1>::HwInit();
    
    gpt<Timerx,tick,Autoreload,1>::InterruptDisable(0xff); 
  ...
  void Start(void)
  {
    gpt<Timerx,tick,Autoreload,1>::InterruptEnable(TIM_IER_UIE | TIM_IER_CC2IE); 
    gpt<Timerx,tick,Autoreload,1>::Start();
    SampleIndex = 0;
    m_Status = 0;
  }
  ...
  void Stop(void)
  {
    gpt<Timerx,tick,Autoreload,1>::InterruptDisable(TIM_IER_CC2IE);
    //gpt<Timerx,tick,Autoreload,1>::Stop();
    m_Status = 1;
  }  
