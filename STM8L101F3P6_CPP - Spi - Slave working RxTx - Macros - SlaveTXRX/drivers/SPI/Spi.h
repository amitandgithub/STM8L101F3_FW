...
#define SPI_LOG_STATES_SIZE 500
  ...
  public:
   ...
   // void LL_SPI_ClearFlag_OVR();
    ...
    void SrartListeningTXRXIntr8bit(uint8_t* TxBuf,uint8_t* RxBuf, uint8_t Len);
...
#define SPI_BYTE_IN_OUT_8_BIT(_SPI_,__BUF)    __BUF.RxBuf[__BUF.RxIdx++] = _SPI_->DR; _SPI_->DR = __BUF.TxBuf[__BUF.TxIdx++]
