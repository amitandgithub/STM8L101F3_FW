...
template<uint8_t slaveAddress>//,uint8_t* txBuf, uint8_t txLen, uint8_t* rxBuf, uint8_t rxLen, uint8_t repeatedStart, I2CStatus_t* pstatus, I2CCallback_t xferDoneCallback>
I2CStatus_t I2cXferIntr();
...
{
public:
    TxnPoll():SlaveAddress(slaveAddress),RepeatedStart(repeatedStart),Status(0),TxLen(txLen),RxLen(rxLen){};
    uint8_t                 SlaveAddress;
    uint8_t                 RepeatedStart;
