...
#define I2C_SLAVE_BUF_BYTE_IN(__I2C_BUF)        __I2C_BUF->RxBuf[__I2C_BUF->RxIndex++] = I2C_DATA_REG

#define I2C_SLAVE_BUF_BYTE_OUT(__I2C_BUF)        I2C_DATA_REG = __I2C_BUF->TxBuf[__I2C_BUF->TxIndex++]
