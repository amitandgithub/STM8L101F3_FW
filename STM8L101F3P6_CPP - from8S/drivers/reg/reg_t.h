...
struct reg_t
{
   ...
   //static_assert(width + offset <= std::numeric_limits<unsigned>::digits, "register width overflow");
   ...
   {
      return mutability_policy_t::read(reinterpret_cast<volatile unsigned *>(address),offset,generate_mask_t<offset, width>::value);
   }
   ...
   {
      mutability_policy_t::write( reinterpret_cast<volatile unsigned *>(address), offset, generate_mask_t<offset, width>::value,value );
   }
   ...
   static void set()
   {
      mutability_policy_t::set( reinterpret_cast<volatile unsigned *>(address), generate_mask_t<offset, width>::value );
   }
   ...
   static void clear()
   {
      mutability_policy_t::clear( reinterpret_cast<volatile unsigned *>(address), generate_mask_t<offset, width>::value );
   }
};
