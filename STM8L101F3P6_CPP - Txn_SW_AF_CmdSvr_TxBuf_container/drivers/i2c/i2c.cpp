...
void i2c::SwitchSlaveTxBuf(i2cBuf_t* i2cSlaveTxBuf)
{
  m_SlaveTxn.TxBuf = i2cSlaveTxBuf;
...
void i2c::SwitchSlaveRxBuf(i2cBuf_t* i2cSlaveRxBuf)
{
  m_SlaveTxn.RxBuf = i2cSlaveRxBuf;
}
